...
public class Vehicle extends Asset {
    public Vehicle(String description, String dataAcquired, String originalCost) {
    ...
    public Vehicle(String description, String dataAcquired, String originalCost, String makeModel, int year, int odometer) {
        super(description, dataAcquired, originalCost);
